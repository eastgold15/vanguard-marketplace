---
name: bun
description: 项目预设 使用 Bun 运行时进行文件操作、包管理和脚本执行。
---
...
1. 使用ultracity来做代码格式化
2. 使用shadcn +tailwindcss
3. 使用bun作为包管理器，除了tauri项目使用pnpm
4. 后台管理项目使用 https://github.com/eastgold15/next-shadcn-admin-dashboard  这个模板
